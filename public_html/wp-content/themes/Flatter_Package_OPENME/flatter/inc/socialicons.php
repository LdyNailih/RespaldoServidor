...
function flatter_social_media_array() {
...
add_action('customize_register', 'flatter_social_sites_customizer');
 
function flatter_social_sites_customizer($wp_customize) {
 
    $wp_customize->add_section( 'flatter_settings', array( 
            'title'          => 'Social Media Icons',
            'priority'       => 38, 
    ) );
 
    $social_sites = flatter_social_media_array();
    $priority = 5;
