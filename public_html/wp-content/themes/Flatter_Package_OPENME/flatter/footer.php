...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo"> 
    	<div class="grid grid-pad">
        	...
        	<div class="col-1-3">
            	...
            	<?php if ( get_theme_mod( 'flatter_footer_phone' ) ) : ?>
        			<h5><?php echo esc_html( get_theme_mod( 'flatter_footer_phone' )); ?></h5>
            	<?php else : ?>   
				<?php endif; ?>
        	</div><!-- .col-1-3 -->
        	...
        	<div class="col-1-3">
            	...
            	<?php if ( get_theme_mod( 'flatter_footer_address' ) ) : ?>
        			<h5><?php echo esc_html( get_theme_mod( 'flatter_footer_address' )); ?></h5> 
            	<?php else : ?>   
				<?php endif; ?>
        	</div><!-- .col-1-3 -->
        	...
        	<div class="col-1-3">
            	...
            	<?php if ( get_theme_mod( 'flatter_footer_contact' ) ) : ?>
        			<h5><?php echo esc_html( get_theme_mod( 'flatter_footer_contact' )); ?></h5>
            	<?php else : ?>   
				<?php endif; ?>
        	</div><!-- .col-1-3 -->
        ...
        <?php if ( get_theme_mod( 'flatter_footerid' ) ) : ?> 
        			<?php echo esc_html( get_theme_mod( 'flatter_footerid' )); ?>   
				<?php else : ?>  
